    ...
    Double_t minHltJetEff = 0.99)
{
  ...
  TCut selSpecMBJet(Form("jet<%1.1f",effJetPt["gHltEff_HltJet6U"]));
  ...
  nt_jettrk->Draw("pt>>hSpecMBHF","","goff");
  nt_jettrk->Draw("pt>>hSpecMBJet",selSpecMBJet,"goff");
  ...
  cpTrigSpec.AddHist1D(trigSpec.hm_["hSpecMBHF"],"MB_HF","hist",kBlack);
  cpTrigSpec.AddHist1D(trigSpec.hm_["hSpecMBJet"],"MB+Jet","",kViolet+2);
