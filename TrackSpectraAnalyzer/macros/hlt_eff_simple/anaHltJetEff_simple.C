...
void anaHltJetEff_simple(TString sampleName="Data",
    const char * inFileName = "../process_aod/outputs/trkhists_try9_100k.root",
    ...
    Int_t reBinFactor = 8)
{
  ...
  cpJetPt.AddHist1D(hs1D["hJet0Pt"],"MinBias All","",kViolet+2);
  cpJetPt.AddHist1D(hs1D["hJet0Pt_HltJet6U"],"HLT: Jet6^{Raw}","",kAzure+6);
  cpJetPt.AddHist1D(hs1D["hJet0Pt_HltJet15U"],"HLT: Jet15^{Raw}","",kGreen-3);
  cpJetPt.AddHist1D(hs1D["hJet0Pt_HltJet30U"],"HLT: Jet30^{Raw}","",kOrange-5);
  cpJetPt.AddHist1D(hs1D["hJet0Pt_HltJet50U"],"HLT: Jet50^{Raw}","",kRed-2);
  ...
  cpHltEff.AddGraph(gAEs["gHltEff_HltJet6U"],"HLT: Jet6U","pz",kAzure+6);
