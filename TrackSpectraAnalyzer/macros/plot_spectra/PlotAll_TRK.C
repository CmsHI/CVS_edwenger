...
void PlotAll_TRK()
{
   ...
   */
   ...
   th1Style1(dndpt_rec_tight_mlt_sec,1,28,1.0,1,1.5,1,1);
   ...
   leg2->AddEntry(dndpt_rec_tight_mlt_sec,"RECO TRK Eff/FR/Mlt/Sec Corr.","pl");
   leg2->Draw();
   ...
   th1Style1(dndpt_rec_tight_mlt_sec_dum,1,28,1.0,1,1.5,1,1);
