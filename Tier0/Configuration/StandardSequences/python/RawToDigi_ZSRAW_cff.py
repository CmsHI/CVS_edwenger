...
scalersRawToDigi.scalersInputTag = 'zsSource'
csctfDigis.producer = 'zsSource'
dttfDigis.DTTF_FED_Source = 'zsSource'
gctDigis.inputLabel = 'zsSource'
gtDigis.DaqGtInputTag = 'zsSource'
gtEvmDigis.EvmGtInputTag = 'zsSource'
siPixelDigis.InputLabel = 'zsSource'
siStripDigis.ProductLabel = 'zsSource'
ecalDigis.DoRegional = False
ecalDigis.InputLabel = 'zsSource'
ecalPreshowerDigis.sourceTag = 'zsSource'
hcalDigis.InputLabel = 'zsSource'
muonCSCDigis.InputObjects = 'zsSource'
muonDTDigis.inputLabel = 'zsSource'
muonRPCDigis.InputLabel = 'zsSource'
castorDigis.InputLabel = 'zsSource'
