...
{
  hchi2seedAll = file->make<TH1F>("hchi2seedAll","hchi2seedAll",2000,0,200);
  hchi2seedProb = file->make<TH1F>("hchi2seedProb","hchi2seedProb",2000,0,200);
  ...
  for (int i=0; i!=6; i++)
    for (int j=0; j!=9; j++){
      ...
      hPullX_shrh[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
      title.str("");
      title << "pullY_" << i+1 << "-" << j+1 << "_sh-rh";
      hPullY_shrh[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
      title.str("");
      title << "pullX_" << i+1 << "-" << j+1 << "_sh-st";
      hPullX_shst[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
      title.str("");
      title << "pullY_" << i+1 << "-" << j+1 << "_sh-st";
      hPullY_shst[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
      title.str("");
      title << "pullX_" << i+1 << "-" << j+1 << "_st-rh";
      hPullX_strh[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
      title.str("");
      title << "pullY_" << i+1 << "-" << j+1 << "_st-rh";
      hPullY_strh[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
      title.str("");
      title << "PullGP_X_" << i+1 << "-" << j+1 << "_sh-st";
      hPullGP_X_shst[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
      title.str("");
      title << "PullGP_Y_" << i+1 << "-" << j+1 << "_sh-st";
      hPullGP_Y_shst[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
      title.str("");
      title << "PullGP_Z_" << i+1 << "-" << j+1 << "_sh-st";
      hPullGP_Z_shst[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
      if ( ((i==2||i==4)&&(j==0||j==1)) || (i==3||i==5) ){
	title.str("");
	title << "pullM_" << i+1 << "-" << j+1 << "_sh-rh";
	hPullM_shrh[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
	title.str("");
	title << "pullS_" << i+1 << "-" << j+1 << "_sh-rh";
	hPullS_shrh[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
	title.str("");
	title << "pullM_" << i+1 << "-" << j+1 << "_sh-st";
	hPullM_shst[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
	title.str("");
	title << "pullS_" << i+1 << "-" << j+1 << "_sh-st";
	hPullS_shst[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
	title.str("");
	title << "pullM_" << i+1 << "-" << j+1 << "_st-rh";
	hPullM_strh[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
	title.str("");
	title << "pullS_" << i+1 << "-" << j+1 << "_st-rh";
	hPullS_strh[title.str()] = file->make<TH1F>(title.str().c_str(),title.str().c_str(),1000,-50,50);
      }
    }

  hPullGPXvsGPX_shst   = file->make<TH2F>("PullGPXvsGPX_shst","PullGPXvsGPX_shst",1000,-50,50,100,-50,50);
  hPullGPXvsGPY_shst   = file->make<TH2F>("PullGPXvsGPY_shst","PullGPXvsGPY_shst",1000,-50,50,100,-50,50);
  hPullGPXvsGPZ_shst   = file->make<TH2F>("PullGPXvsGPZ_shst","PullGPXvsGPZ_shst",1000,-50,50,200,-100,100);
  hPullGPXvsGPr_shst   = file->make<TH2F>("PullGPXvsGPr_shst","PullGPXvsGPr_shst",1000,-50,50,300,-150,150);
  hPullGPXvsGPeta_shst = file->make<TH2F>("PullGPXvsGPeta_shst","PullGPXvsGPeta_shst",1000,-50,50,50,-2.5,2.5);
  hPullGPXvsGPphi_shst = file->make<TH2F>("PullGPXvsGPphi_shst","PullGPXvsGPphi_shst",1000,-50,50,63,0,6.3);
